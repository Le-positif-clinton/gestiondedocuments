package com.clinton.gestiondedocuments.utils;
...
public class JwtUtil {
    ...
    public String extractIdGroupe(String token){
        final Claims claims = extractAllClaims(token);

        return claims.get("idGroupe", String.class);
    }
    ...
    private String createToken(Map<String, Object> claims, ExtendedUser userDetails){
        return Jwts.builder().setClaims(claims)
                ...
                .claim("idGroupe", userDetails.getIdGroupe().toString())
